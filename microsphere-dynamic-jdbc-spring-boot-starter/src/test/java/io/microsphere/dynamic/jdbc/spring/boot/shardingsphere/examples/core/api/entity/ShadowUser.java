...
package io.microsphere.dynamic.jdbc.spring.boot.shardingsphere.examples.core.api.entity;
...
public class ShadowUser implements Serializable {
    ...
    public String toString() {
        return String.format("user_id: %d, user_type: %d, username: %s, username_plain: %s, pwd: %s, assisted_query_pwd: %s", userId, userType,
                username, usernamePlain, pwd, assistedQueryPwd);
    }
}
